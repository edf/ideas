...
def create_gui():
    ...
    instance_listbox_label = tk.Label(root, text="Instances:")
    ...
    tag_key_label = tk.Label(root, text="Tag Key:")
    tag_key_label.grid(row=2, column=0, padx=10, pady=10)
    tag_key_entry = tk.Entry(root)
    tag_key_entry.grid(row=2, column=1, padx=10, pady=10)

    tag_value_label = tk.Label(root, text="Tag Value:")
    tag_value_label.grid(row=3, column=0, padx=10, pady=10)
    tag_value_entry = tk.Entry(root)
    tag_value_entry.grid(row=3, column=1, padx=10, pady=10)

    get_instances_button = tk.Button(root, text="Get Instances", command=lambda: get_instances(region_entry, instance_listbox, instance_id_map))
    get_instances_button.grid(row=4, column=0, padx=10, pady=10)

    update_tag_button = tk.Button(root, text="Update Tag", command=lambda: update_tag(instance_listbox, instance_id_map, region_entry, tag_key_entry, tag_value_entry, tags_display))
    ...
    volumes_listbox_label = tk.Label(root, text="Volumes:")
    ...
    update_volume_tag_button = tk.Button(root, text="Update Volume Tag", command=lambda: update_volume_tag(volumes_listbox, region_entry, tag_key_entry, tag_value_entry, tags_display))
